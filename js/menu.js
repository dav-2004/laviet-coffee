...
// View 13
const view13 = document.querySelector(".thirteen__view");
const view13OpenBtn = document.querySelector(".thirteen__view__openBtn");
const view13CloseBtn = document.querySelector(".thirteen__view__closeBtn");
const view13Overlay = document.querySelector(".thirteen__view-overlay");

view13OpenBtn.addEventListener("click", function () {
  view13.classList.add("thirteen__showview");
  view13Overlay.classList.add("thirteen__transparentBcg");
  html.classList.add("no-scroll");
});

view13CloseBtn.addEventListener("click", function () {
  view13.classList.remove("thirteen__showview");
  view13Overlay.classList.remove("thirteen__transparentBcg");
  html.classList.remove("no-scroll");
});

// View 14
const view14 = document.querySelector(".fourteen__view");
const view14OpenBtn = document.querySelector(".fourteen__view__openBtn");
const view14CloseBtn = document.querySelector(".fourteen__view__closeBtn");
const view14Overlay = document.querySelector(".fourteen__view-overlay");

view14OpenBtn.addEventListener("click", function () {
  view14.classList.add("fourteen__showview");
  view14Overlay.classList.add("fourteen__transparentBcg");
  html.classList.add("no-scroll");
});

view14CloseBtn.addEventListener("click", function () {
  view14.classList.remove("fourteen__showview");
  view14Overlay.classList.remove("fourteen__transparentBcg");
  html.classList.remove("no-scroll");
});

// View 15
const view15 = document.querySelector(".fifteen__view");
const view15OpenBtn = document.querySelector(".fifteen__view__openBtn");
const view15CloseBtn = document.querySelector(".fifteen__view__closeBtn");
const view15Overlay = document.querySelector(".fifteen__view-overlay");

view15OpenBtn.addEventListener("click", function () {
  view15.classList.add("fifteen__showview");
  view15Overlay.classList.add("fifteen__transparentBcg");
  html.classList.add("no-scroll");
});

view15CloseBtn.addEventListener("click", function () {
  view15.classList.remove("fifteen__showview");
  view15Overlay.classList.remove("fifteen__transparentBcg");
  html.classList.remove("no-scroll");
});

// View 16
const view16 = document.querySelector(".sixteen__view");
const view16OpenBtn = document.querySelector(".sixteen__view__openBtn");
const view16CloseBtn = document.querySelector(".sixteen__view__closeBtn");
const view16Overlay = document.querySelector(".sixteen__view-overlay");

view16OpenBtn.addEventListener("click", function () {
  view16.classList.add("sixteen__showview");
  view16Overlay.classList.add("sixteen__transparentBcg");
  html.classList.add("no-scroll");
});

view16CloseBtn.addEventListener("click", function () {
  view16.classList.remove("sixteen__showview");
  view16Overlay.classList.remove("sixteen__transparentBcg");
  html.classList.remove("no-scroll");
});

// View 17
const view17 = document.querySelector(".seventeen__view");
const view17OpenBtn = document.querySelector(".seventeen__view__openBtn");
const view17CloseBtn = document.querySelector(".seventeen__view__closeBtn");
const view17Overlay = document.querySelector(".seventeen__view-overlay");

view17OpenBtn.addEventListener("click", function () {
  view17.classList.add("seventeen__showview");
  view17Overlay.classList.add("seventeen__transparentBcg");
  html.classList.add("no-scroll");
});

view17CloseBtn.addEventListener("click", function () {
  view17.classList.remove("seventeen__showview");
  view17Overlay.classList.remove("seventeen__transparentBcg");
  html.classList.remove("no-scroll");
});

// View 18
const view18 = document.querySelector(".eighteen__view");
const view18OpenBtn = document.querySelector(".eighteen__view__openBtn");
const view18CloseBtn = document.querySelector(".eighteen__view__closeBtn");
const view18Overlay = document.querySelector(".eighteen__view-overlay");

view18OpenBtn.addEventListener("click", function () {
  view18.classList.add("eighteen__showview");
  view18Overlay.classList.add("eighteen__transparentBcg");
  html.classList.add("no-scroll");
});

view18CloseBtn.addEventListener("click", function () {
  view18.classList.remove("eighteen__showview");
  view18Overlay.classList.remove("eighteen__transparentBcg");
  html.classList.remove("no-scroll");
});
